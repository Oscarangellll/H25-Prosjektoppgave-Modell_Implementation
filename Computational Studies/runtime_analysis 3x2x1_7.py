...
wind_farms = range(2, 3) #runs for n_wind_farms = 2
scenarios = range(1, 8) #runs for n_scenarios = 1, 2, ..., 7
...
import csv
with open("runtime_analysis_results 3x2x1_7.csv", mode="w", newline="") as file:
