...
def make_case(name, n_vessels, n_wind_farms, n_scenarios, seed):
    vessel_types = [
    ...
    wind_farms = [
        ...
        WindFarm("Wind Farm C", coordinates=(54.0, 7.3), n_turbines=100, weather_data_file="Location 1.csv", turbine_model="Nordex_N90_2500"),
        WindFarm("Wind Farm D", coordinates=(54.0, 7.3), n_turbines=100, weather_data_file="Location 1.csv", turbine_model="Nordex_N90_2500"),
        WindFarm("Wind Farm E", coordinates=(54.0, 7.3), n_turbines=100, weather_data_file="Location 1.csv", turbine_model="Nordex_N90_2500"),
    ]
