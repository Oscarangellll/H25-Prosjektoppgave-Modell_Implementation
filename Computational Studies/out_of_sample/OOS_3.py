...
solutions = [
    ...
    ['gamma_ST[CTV,November]: 1.0', 'gamma_LT[CTV]: 1.0', 'gamma_LT[SOV]: 1.0']
    ['gamma_ST[CTV,February]: 1.0', 'gamma_LT[CTV]: 1.0', 'gamma_LT[SOV]: 1.0']
    ['gamma_ST[CTV,December]: 1.0', 'gamma_LT[CTV]: 1.0', 'gamma_LT[SOV]: 1.0']
    ['gamma_ST[CTV,January]: 1.0', 'gamma_LT[CTV]: 1.0', 'gamma_LT[SOV]: 1.0']
]
...
#save average to csv
import csv
with open("OOS_3_results.csv", "w", newline="") as f:
    writer = csv.writer(f)
