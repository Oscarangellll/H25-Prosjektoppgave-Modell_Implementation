...
vessels = [
    ...
    VesselType("SOV", n_teams=5, max_wind=20, max_wave=2.5, shift_length=12, day_rate=50, mob_rate=1000)
]
wind_farms = [
...
failures = {
    ...
    ("Wind Farm A", "Small", 2, 1): 0, #swap here
    ...
    ("Wind Farm A", "Large", 1, 1): 0,
    ("Wind Farm A", "Large", 2, 1): 1, #swap here
